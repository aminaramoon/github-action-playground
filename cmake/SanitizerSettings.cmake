function(enable_sanitizers target_name)
  ...
  if(NOT TARGET ${target_name})
    message(
      FATAL_ERROR "enable_sanitizers called on undefined target: ${target_name}"
    )
  endif()

  set(SANITIZERS
      "none"
      CACHE STRING "Select sanitizer: address, thread, undefined, leak, none")
  set_property(CACHE SANITIZERS PROPERTY STRINGS "none" "address" "thread"
                                         "undefined" "leak")
